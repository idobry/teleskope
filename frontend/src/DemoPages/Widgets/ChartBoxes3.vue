<template>
    ...
    <page-title :heading=$route.params.namespace :subheading=subheading :icon=icon></page-title>
             ...
             <div class="row mt-4">
            <div class="col-lg-6 col-xl-12"  v-for="(deployment,index) in deployments" :key="index" >    
                ...
                <div class="card mb-3 widget-content">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="widget-superheading text-success"><span>{{ deployment }}</span></div>
                        </div>
                        <div class="widget-content-right">
                            <div class="widget-heading">image</div>
                            <div class="widget-subheading">last update at</div>
                        </div>
                    </div>
                </div>
              </router-link>
...
<script>
    ...
    export default {
        ...
        async beforeMount() {
            this.deployments = await this.apiService.listDeploymentsAt(this.$route.params.namespace)
            this.subheading = `${this.deployments.length || 0 } Deployments:`
        },
        methods: {
